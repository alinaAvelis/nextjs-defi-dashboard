...
const variantStyles = {
	primary:
		"bg-black dark:bg-white text-white dark:text-black hover:bg-slate-700",
	secondary:
		"bg-none border border-black dark:border-white hover:bg-gray-100 dark:hover:bg-gray-800",
